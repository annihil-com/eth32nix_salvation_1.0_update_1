...
{
//Removed esp radar from disappearing when original hud is enabled
...
//	eth32.cg.media.classIcons[player->Class
//	Draw.Pic((cx/scaleX)-3.5, (cy/scaleY)-3.5, 7, 7, eth32.cg.media.classIcons[player->Class]);
